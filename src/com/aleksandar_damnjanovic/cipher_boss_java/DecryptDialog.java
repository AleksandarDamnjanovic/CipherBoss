...
public class DecryptDialog extends JFrame {
	...
	public DecryptDialog() {
		...
		this.setTitle("Cipher Boss decryption dialog");
		...
		JLabel lblAreYouSure = new JLabel("<html>Are you sure that you want<br/> to continue with decryption?</html>");
				...
				try {
					...
					EventQueue.invokeLater(new Runnable() {
						...
						public void run() {
							...
							wait.addEffect("Please wait","Decryption process is running",key, false);
						}
					});
		...
		okCommand.setToolTipText("Proceed with decryption");
